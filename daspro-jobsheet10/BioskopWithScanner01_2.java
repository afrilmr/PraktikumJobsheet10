...
public class BioskopWithScanner01_2 {
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    if (baris >= 1 && baris <= 4 && kolom >= 1 && kolom <= 2) {
                        if (penonton[baris - 1][kolom - 1] == null) {
                            ...
                            System.out.println();
                            //Menampilkan kursi sudah terisi
                            System.out.println("Kursi sudah terisi!");
                        }
                    } else {
                        //Menampilkan Baris atau kolom tidak tersedia
                    ...
                    for (int i = 0; i < 4; i++) {
                        for (int j = 0; j < 2; j++) {
                            if (penonton[i][j] != null) {
                                ...
                                // Menam[pilkan jika kursi kosong, null diganti dengan ***
                ...
                default:
                    System.out.println("Menu tidak tersedia. Harap pilih menu yang sesuai!");
            }
        }
    }
}